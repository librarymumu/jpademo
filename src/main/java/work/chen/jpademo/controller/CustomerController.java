...
public class CustomerController {
  ...
  /**
   * Hibernate: insert into jpa_customer (age, name, phone, sex, id) values (?, ?, ?, ?, ?)
   * Hibernate: insert into jap_order (tprice, oid) values (?, ?)
   * Hibernate: update jap_order set cid=? where oid=?
   * @return
   */
  @RequestMapping(value = "/saveTest", method = RequestMethod.POST)
  public int saveTest() {
    return customerService.saveCustomerAndOrder();
  }
  ...
  /**
   * left join 查询
   * Hibernate: select customeren0_.id as id1_2_, customeren0_.age as age2_2_, customeren0_.name as name3_2_, customeren0_.phone as phone4_2_, customeren0_.sex as sex5_2_ from jpa_customer customeren0_ left outer join jap_order orderentit1_ on customeren0_.id=orderentit1_.assid where orderentit1_.oid=2
   * Hibernate: select orderentit0_.assid as assid3_0_0_, orderentit0_.oid as oid1_0_0_, orderentit0_.oid as oid1_0_1_, orderentit0_.tprice as tprice2_0_1_ from jap_order orderentit0_ where orderentit0_.assid=?
   * @return
   */
